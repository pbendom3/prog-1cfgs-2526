...
- Para **repetir instrucciones** (por ejemplo, para seguir pidiendo al usuario el valor de entrada mientras no sea correcto o ejecutar alguna instrucción varias veces).
    ...
    - En el caso de que necesitemos **controlar la entrada del usuario**, por ejemplo, aceptando solamente números positivos.

    ![](image6.png)

    - Y en el caso en que necesitemos repetir un bloque un número determinado de veces, por ejemplo, 3.
